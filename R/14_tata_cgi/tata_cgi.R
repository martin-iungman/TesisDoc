...
ggsave(file.path(out_dir, "tata_scatter.jpg"), panel_tata_scatter, width = 12, height = 6.75, units = "in")
...
ggsave(file.path(out_dir, "cgi_scatter.jpg"), panel_cgi_scatter, width = 12, height = 6.75, units = "in")
...
ggsave(file.path(out_dir, "ccaat_scatter.jpg"), panel_ccaat_scatter, width = 12, height = 6.75, units = "in")
